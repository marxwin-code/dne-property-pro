...
function parseBody(raw: unknown): { input: PropertyRiskReportInput; tier: "free" | "full" } | null {
      ...
      return NextResponse.json(
        {
          success: false,
          message:
            "Invalid input. Required: income, savings, location (or userLocation), property: { price, location, type }. Optional: ownership, tier (free|full)."
        },
        { status: 400 }
      );
    }
