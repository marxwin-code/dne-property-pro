...
export const zh: SiteText = {
  ...
  invoiceExtract: {
    ...
    lead: "最多上传 100 份 Taskforce PDF（合计小于 50 MB）：按固定规则解析、与 Airtable 房源匹配、按发票号去重，合并为一份周导入 Excel。",
    backToLabs: "返回 Labs",
    uploadLabel: "PDF 发票（可多选，最多 100 个，合计小于 50 MB）",
    uploadHint: "须为有效 PDF。相同 TF 发票号仅保留首次出现的记录。",
    submit: "提取并下载 Excel",
    processing: "处理中...",
    download: "再次下载 Excel",
    errorGeneric: "出错了，请重试。",
    errorNoPdf: "请至少选择一个 PDF 文件。",
    errorTooManyFiles: "一次最多上传 {{max}} 个 PDF 文件。",
    errorBatchTooLarge: "所选文件合计大小须小于 {{mb}} MB。",
